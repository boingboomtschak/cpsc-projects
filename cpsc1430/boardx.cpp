// Devon McKee
// boardx.cpp
// Implementation of Board as described in boardx.h
// 2019-1-17
...
int Board::takeTurn(string name, int& space)
{
  ...
  if(newSpace == 2 || newSpace == 92){
    cout << name << " landed on an extra turn space!\n";
  }
  if(newSpace == 37 || newSpace == 70){
    cout << name << " landed on a skip turn space..\n";
  }
